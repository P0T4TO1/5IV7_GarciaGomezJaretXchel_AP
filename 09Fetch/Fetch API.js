...
const pokedex = () => {
    ...
    const processPokemonTypes = (pokemonData) => {
        ...
        if (currentClassType) {
            ...
            containers.pokemonAbilitiesElement.classList.remove(
                currentClassType
            );
        }
    ...
    const processPokemonStats = (pokemonData) => {
        ...
        pokemonData.stats?.forEach((pokemonStatData) => {
            ...
            switch (pokemonStatData.stat.name) {
                case "hp":
                    pokemonStatsElements.hp.innerHTML =
                    ...
                    break;
                case "attack":
                    pokemonStatsElements.attack.innerHTML =
                        pokemonStatData.base_stat;
                    ...
                    break;
                case "defense":
                    pokemonStatsElements.defense.innerHTML =
                        pokemonStatData.base_stat;
                ...
                case "special-defense":
                    ...
                    break;
                case "speed":
                    pokemonStatsElements.speed.innerHTML =
                        pokemonStatData.base_stat;
